...
public class RuleCreateDTO {
    ...
    @Schema(description = "规则名称", example = "问候语规则", required = true)
    ...
    @Schema(description = "匹配类型", example = "CONTAINS", required = true)
    ...
    @Schema(description = "匹配模式", example = "你好|hello|hi", required = true)
    ...
    @Schema(description = "优先级 (1-1000, 数字越小优先级越高)", example = "100", required = true)
    ...
    private OnErrorPolicy onErrorPolicy = OnErrorPolicy.LOG_ONLY;
